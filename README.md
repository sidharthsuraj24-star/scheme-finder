...
- Data: data/schemes.json (curated schemes — India multi-state/central + BD/NP/LK/MV starters + US federal/state waves incl. Wave 5 CO/MN/SC/AL/LA, Wave 6 KY/OR/OK/CT/UT, and Wave 7 IA/NV/AR/MS/KS; in-memory; optional SQLite)
- Tests: pytest
