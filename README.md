...
- Data: data/schemes.json (curated schemes — India multi-state/central + BD/NP/LK/MV starters + US federal/state waves incl. Wave 5 CO/MN/SC/AL/LA, Wave 6 KY/OR/OK/CT/UT, Wave 7 IA/NV/AR/MS/KS, and Wave 8 NM/NE/ID/HI/ME; in-memory; optional SQLite)
- Tests: pytest
