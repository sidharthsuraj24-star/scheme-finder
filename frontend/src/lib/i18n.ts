...
const en: Dict = {
  ...
  qIncomeAboutYear: "About ₹{amount} per year",
  qIncomeAboutMonth: "About ₹{amount} per month",
...
const ml: Dict = {
  ...
  qIncomeHint: "മാസം / വർഷം തിരഞ്ഞെടുത്ത് ഏകദേശ തുക ₹-യിൽ നൽകുക.",
  qIncomeMonthly: "മാസം",
  qIncomeYearly: "വർഷം",
  qIncomeMonthlyLabel: "മാസ കുടുംബ വരുമാനം",
  qIncomeYearlyLabel: "വാർഷിക കുടുംബ വരുമാനം",
  qIncomeAboutYear: "ഏകദേശം വർഷം ₹{amount}",
  qIncomeAboutMonth: "ഏകദേശം മാസം ₹{amount}",
